...
<div class="container-fluid">
    ...
    {{-- ================================================================
         Determine Whether We Have A Selected Invoice
    ================================================================= --}}
                        ...
                        <div class="col-md-8">
                            ...
                            >
                                ...
                                {{-- =================================================
                                     ...
                                     This protects against a controller where
                                     selectedInvoice exists but it isn't included
                                ...
                                @if(
                                    $hasSelectedInvoice
                                    &&
                                    !$invoices->contains('id', $selectedInvoice->id)
                                )
...
document.addEventListener(
    ...
    function () {
        ...
        */
        ...
        function updateInvoice() {
            ...
            */
            ...
            /*
            |--------------------------------------------------------------------------
            | Automatically Select Milestone
            |--------------------------------------------------------------------------
            */
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Prevent Manual Amount Above Maximum
        |--------------------------------------------------------------------------
        */
            ...
            function (event) {
                ...
                */
                ...
                if (
                    ...
                    alert(
                        'Payment amount cannot exceed the invoice outstanding amount.'
                    );
