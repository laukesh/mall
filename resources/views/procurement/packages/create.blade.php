...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a
            href="{{ route('admin.procurement.packages.index') }}"
    ...
    <form
        method="POST"
        action="{{ route('admin.procurement.packages.store') }}"
    >
                ...
                <div class="row g-3">
                        ...
                        >
                            ...
                            @foreach($procurementPlans as $plan)
                                ...
                                <option
                                    value="{{ $plan->id }}"
                                    @selected(
                                        old('procurement_plan_id', $selectedPlanId)
                                        == $plan->id
                                    )
                                >
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            step="0.01"
                            min="0"
                            value="{{ old('estimated_value', '0.00') }}"
                        >
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadBudgets(planId, selectedBudgetId = null) {
