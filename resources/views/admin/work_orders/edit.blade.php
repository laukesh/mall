...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="fas fa-layer-group me-2"></i>Edit Work Order</h4>
            <div class="text-muted">Update work order.</div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.maintenance.work-orders.update', $item->id) }}">
                @csrf
                @method('PUT')
                @include('admin.work_orders._form', ['item' => $item ?? null])
