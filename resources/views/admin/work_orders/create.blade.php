...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="fas fa-layer-group me-2"></i>Create Work Order</h4>
            <div class="text-muted">Add a new work order.</div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.maintenance.work-orders.store') }}">
                @csrf
