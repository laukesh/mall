...
@section('title', 'Create Vendor Performance')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="fas fa-layer-group me-2"></i>Create Vendor Performance</h4>
            <div class="text-muted">Add a new vendor performance.</div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.maintenance.vendor-performance.store') }}">
                @csrf
                ...
                <div class="d-flex justify-content-end gap-2 mt-3">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-1"></i>Create Vendor Performance
                    </button>
                </div>
            </form>
        </div>
