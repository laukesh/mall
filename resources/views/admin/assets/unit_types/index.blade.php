...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        @can('unit_types.create')
            ...
            <a
                href="{{ route('admin.assets.unit_types.create') }}"
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form
                method="GET"
                action="{{ route('admin.assets.unit_types.index') }}"
            >
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2 d-flex align-items-end gap-2">
                        ...
                        <a
                            href="{{ route('admin.assets.unit_types.index') }}"
                            ...
                            <td class="text-nowrap">
                                ...
                                @can('unit_types.delete')
                                    ...
                                    <form
                                        method="POST"
                                        action="{{ route(
                                            'admin.assets.unit_types.destroy',
                                            $unitType->id
                                        ) }}"
                                        class="d-inline"
                                    >
