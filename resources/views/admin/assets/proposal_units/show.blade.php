...
<x-form-card title="Proposal Unit" subtitle="View proposal unit">
  ...
  <div class="mt-3">
    <a href="{{ route('admin.assets.proposal_units.index') }}" class="btn btn-secondary">Back</a>
    <a href="{{ route('admin.assets.proposal_units.edit', $item->id) }}" class="btn btn-primary">Edit</a>
  </div>
</x-form-card>
@endsection
