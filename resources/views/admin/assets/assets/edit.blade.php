...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="fas fa-boxes me-2"></i>Edit Asset</h4>
            <div class="text-muted">Update asset information.</div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.assets.assets.update', $item->id) }}">
                @csrf
                @method('PUT')
                @include('admin.assets.assets._form')

                <div class="d-flex justify-content-end gap-2 mt-4">
                    <a href="{{ route('admin.assets.assets.show', $item->id) }}" class="btn btn-outline-secondary">
