...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                Manage unit statuses used for mall units.
            </p>
        </div>
        ...
        @can('unit_statuses.create')
            ...
            <a
                href="{{ route('admin.assets.unit-statuses.create') }}"
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form
                method="GET"
                action="{{ route('admin.assets.unit-statuses.index') }}"
            >
                            ...
                            <td class="text-nowrap">
                                ...
                                @can('unit_statuses.delete')
                                    ...
                                    <form
                                        method="POST"
                                        action="{{ route(
                                            'admin.assets.unit-statuses.destroy',
                                            $status->id
                                        ) }}"
                                        class="d-inline"
                                    >
                                        ...
                                        <button
                                            ...
                                            onclick="return confirm(
                                                'Are you sure you want to delete this unit status?'
                                            )"
                                        >
                                            Delete
                                        </button>
