...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="fas fa-layer-group me-2"></i>Edit Preventive Maintenance</h4>
            <div class="text-muted">Update preventive maintenance.</div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.preventive_maintenance.update', $item->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end gap-2 mt-3">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-1"></i>Update Preventive Maintenance
                    </button>
                </div>
            </form>
        </div>
