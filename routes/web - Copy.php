  ...
  Route::prefix('assets')
    ...
    ->group(function () {
        ...
        Route::resource('units', App\Http\Controllers\Admin\Assets\UnitController::class)
            ...
            Route::resource('incomes', AssetIncomeController::class)->middleware([
               ...
               Route::resource('expenses', AssetExpenseController::class)->middleware([
                ...
                'edit'    => 'permission:expenses.edit',
                'update'  => 'permission:expenses.edit',
